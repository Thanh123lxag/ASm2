function checkLogin() {
    ...
    if(currentUser == null || currentUser.userType == 0) {
        document.querySelector("body").innerHTML = `<div class="access-denied-section">
            <img class="access-denied-img" src=".img/access-denied.jpg" alt="">
        </div>`
    } else {
...
function setDefaultValue() {
    document.querySelector(".upload-image-preview").src = "./img/empty-img.jpg";
    document.getElementById("ten-mon").value = "";
    document.getElementById("gia-moi").value = "";
    document.getElementById("mo-ta").value = "";
    document.getElementById("chon-mon").value = "Áo Thể Thao";
}
